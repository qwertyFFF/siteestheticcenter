                ...
                <div className="my-row" style={styles.row_cinza_escuro}>
                    <div className="container">
                        ...
                        <p className="pull-right">
                            Desenvolvido por Alessadro Spiercort && Vilson knaak em <a style={{color:'#d4bdb7'}} href="https://reactjs.org/" target="_blank" rel="noopener noreferrer">ReactJS</a> <img src={react_footer_image} style={{width:'4%'}} alt=""/>
                        </p>
